...
open class SolanaTransactionAPI {
     ...
     */
    open class func solanaGetTransaction(network: String, txSignature: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: Transaction?, _ error: Error?) -> Void)) {

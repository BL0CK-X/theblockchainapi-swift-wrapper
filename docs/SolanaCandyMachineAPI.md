...
let createTestCandyMachineRequest = CreateTestCandyMachineRequest(secretRecoveryPhrase: "secretRecoveryPhrase_example", derivationPath: "derivationPath_example", passphrase: "passphrase_example", network: "network_example", candyMachineContractVersion: "candyMachineContractVersion_example", includeGatekeeper: false) // CreateTestCandyMachineRequest |  (optional)
...
let mintNFTRequest = MintNFTRequest(configAddress: "configAddress_example", secretRecoveryPhrase: "secretRecoveryPhrase_example", derivationPath: "derivationPath_example", passphrase: "passphrase_example", network: "network_example", candyMachineContractVersion: "candyMachineContractVersion_example") // MintNFTRequest |  (optional)
...
```swift
    open class func solanaSearchCandyMachines(candyMachineSearchRequest: CandyMachineSearchRequest? = nil, completion: @escaping (_ data: [CandyMachineSearchResponse]?, _ error: Error?) -> Void)
```

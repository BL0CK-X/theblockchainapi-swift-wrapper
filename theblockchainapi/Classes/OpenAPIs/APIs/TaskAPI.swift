...
open class TaskAPI {
     ...
     */
    open class func getTask(taskId: String, apiResponseQueue: DispatchQueue = theblockchainapiAPI.apiResponseQueue, completion: @escaping ((_ data: Task?, _ error: Error?) -> Void)) {
    ...
    open class func getTaskWithRequestBuilder(taskId: String) -> RequestBuilder<Task> {
        ...
        let localVariableRequestBuilder: RequestBuilder<Task>.Type = theblockchainapiAPI.requestBuilderFactory.getBuilder()

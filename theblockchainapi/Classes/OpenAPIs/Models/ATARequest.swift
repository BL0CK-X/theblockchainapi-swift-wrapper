...
public struct ATARequest: Codable, Hashable {
    ...
    public init(secretRecoveryPhrase: String, derivationPath: String? = "m/44/501/0/0", passphrase: String? = "", tokenAddress: String, network: Network? = .devnet) {

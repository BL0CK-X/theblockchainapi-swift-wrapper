...
public struct CCProject: Codable, JSONEncodable, Hashable {
    ...
    public init(projectId: String, name: String, description: String? = nil, webhook: String? = nil, website: String? = nil, discordWebhook: String? = nil, logoUrl: String? = nil, customerIdToCollect: CCProjectCreateRequestCustomerIdToCollect? = nil, successUrl: String? = nil, payoutMethod: CCProjectCreateRequestPayoutMethod? = nil) {

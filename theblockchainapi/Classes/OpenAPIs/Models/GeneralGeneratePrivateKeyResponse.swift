//
// GeneralGeneratePrivateKeyResponse.swift
//
...
public enum GeneralGeneratePrivateKeyResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(GeneralB58PrivateKey.self) {
            ...
            throw DecodingError.typeMismatch(Self.Type.self, .init(codingPath: decoder.codingPath, debugDescription: "Unable to decode instance of GeneralGeneratePrivateKeyResponse"))
        }
    }
}
